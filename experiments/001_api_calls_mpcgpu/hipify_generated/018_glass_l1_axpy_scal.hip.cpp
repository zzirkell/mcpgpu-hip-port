...
int main()
{
    ...
    CHECK_GPU(hipMemcpy(h_x_float.data(), d_x_float, n * sizeof(float), hipMemcpyDeviceToHost));
    CHECK_GPU(hipMemcpy(h_y_float.data(), d_y_float, n * sizeof(float), hipMemcpyDeviceToHost));
    CHECK_GPU(hipMemcpy(h_x_double.data(), d_x_double, n * sizeof(double), hipMemcpyDeviceToHost));
