...
int main() {
    ...
    CHECK_GPU(cudaMalloc((void**)&d_sums, blocks * sizeof(int)));
    CHECK_GPU(cudaMalloc((void**)&d_sizes, blocks * sizeof(int)));
    ...
    CHECK_GPU(cudaMemcpy(h_sums.data(), d_sums, blocks * sizeof(int), cudaMemcpyDeviceToHost));
    CHECK_GPU(cudaMemcpy(h_sizes.data(), d_sizes, blocks * sizeof(int), cudaMemcpyDeviceToHost));

    CHECK_GPU(cudaFree(d_sums));
    CHECK_GPU(cudaFree(d_sizes));
